...
export const Description = () => {
  return (
    <section className={classes.parent}>
      ...
      <div>
        <p>
          주식회사 범류는 그 영향력이 작을지라도 우리가 할 수 있는 가능한 모든
          영역의 가치실현을 꿈꾸는 사회적 기업 입니다.
        </p>
      </div>
      <div>
        <strong>1</strong>
        <p>
          ...
          제공됩니다. <br /> 언제든, 며천이든 필요하신 만큼 제공해드리고 <br />
          있사오니 부족하시면 말씀해주세요
        </p>
      </div>
      <div>
        <strong>2</strong>
        <p>
          매일 매일 준비된 양만 판매하여 <br /> 재고를 최소화 하기위해 노력하고
          있습니다. <br />
      ...
      <div>
        <strong>4</strong>
        <p>
          판매 수익 중 일부를 저소득층 학생 운동선수들에게 지원하고 있습니다.{' '}
          <br />
      ...
      <div>
        <strong>5</strong>
        <p>
          수평적 기업문화를 구축을 하기 위해 노력합니다. <br /> 또한 공정하고
          투명한 노사관계를 기업 운영의 <br /> 핵심 가치로 여깁니다.
        </p>
      </div>
